        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecurrenceRules_Tasks_TodoTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecurrenceRuleId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskOccurrences_RecurrenceRules_RecurrenceRuleId",
                        column: x => x.RecurrenceRuleId,
                        principalTable: "RecurrenceRules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_TaskOccurrences_Tasks_TodoTaskId",
                        column: x => x.TodoTaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurrenceRules_TodoTaskId",
                table: "RecurrenceRules",
                column: "TodoTaskId",
                unique: true,
                filter: "[TodoTaskId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskOccurrences_RecurrenceRuleId",
                table: "TaskOccurrences",
                column: "RecurrenceRuleId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskOccurrences_TodoTaskId_OccurrenceDate",
                table: "TaskOccurrences",
                columns: new[] { "TodoTaskId", "OccurrenceDate" });
